...
export default function TransactionDetails({ details }: TransactionDetailsProps) {
      ...
      <div className="border rounded-lg p-4 space-y-3">
        ...
        <div className="space-y-2 text-sm">
          <div className="flex justify-between">
            ...
            <span>
              1 χ = {details.type === "buy" ? details.inputAmount : details.outputAmount}{" "}
              {details.type === "buy" ? details.inputCurrency.toUpperCase() : details.outputCurrency.toUpperCase()}
            </span>
          </div>
